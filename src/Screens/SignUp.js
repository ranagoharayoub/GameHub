            ...
            <div className='signup-cont'>
                <div className='signup-sect'>
                    ...
                    <form className='form-sect'>
                            <input required className='input-fields' name="username" value={this.state.username} onChange={(e) => this.handleChange(e)} type='text' placeholder='Username'></input>
                            <input required className='input-fields' name="email" value={this.state.email} onChange={(e) => this.handleChange(e)} type='email' placeholder='Email Address'></input>
                            <input required className='input-fields' name="pass" value={this.state.pass} onChange={(e) => this.handleChange(e)} type='pass' placeholder='Create Password'></input>
                            ...
                            <input required className='input-fields' name="confpass" value={this.state.confpass} onChange={(e) => this.handleChange(e)} type='password' placeholder='Confirm Password'></input>
                            <label className='phone'>Phone Number</label>
                            <div>
                            <input required style={{width:'20%', borderRight: '1px solid white'}}  name="phoneext" value={this.state.phoneext} onChange={(e) => this.handleChange(e)}  placeholder='+1' className='input-fields' type="tel"></input>
                            <input required style={{width:'80%'}} className='input-fields' type="tel" name="phone" value={this.state.phone} onChange={(e) => this.handleChange(e)} placeholder='e.g. 1324568974555'></input>
                            </div>
                            <select className='input-fields' id='option'  name="timezone"
                                ...
                                <option  value="0">Africa/Bamako&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;(GMT-0)</option>
                            ...
                            <div className='dob-sec'>   
                                <select className='dob' id='option'  name="day"
                                ...
                                <select className='dob' id='option' name="month"
                                ...
                                <select className='dob' id='option' name="year"
                            ...
                            <div className='check-policy'>
                                <input className='checkbox' name="term" type='checkbox' onChange={(e) => this.handleChange2(e)}></input>
                                <div className='checkbox-label'>Click to accept Terms and Conditions and Privacy Policy.</div>
                            </div>
                            <div className='check-policy'>
                                <input className='checkbox' name="eight" type='checkbox' onChange={(e) => this.handleChange2(e)}></input>
